<template>
  <div>
    ...
    <div  class="komentar">
      ...
      <p>{{ exerciseData[0].ex_desc }}</p>
    </div>

    <div class="adminovi">
      <button @click="goBack2" v-if="isAdmin">Back</button>
      <button @click="goForward" v-if="isAdmin">Forward</button>
    </div>

    <div class="back">
      <button @click="goBack" v-if="!isAdmin">Back To My Plan</button>
    </div>
