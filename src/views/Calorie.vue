...
<div class="formIner">
    ...
    <br>
        ...
        <input class="Inner" type="int" placeholder="Enter your Height" v-model.trim="arr.height" required>
    
    
    <br>
    
        <!-- <h3>Enter your weight : </h3> -->
        <input class="Inner" type="int" placeholder="Enter your Weight" v-model.trim="arr.weight" required>
