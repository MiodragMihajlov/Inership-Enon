...
<div class="login">
  <div class="form">
    ...
    <input :style="validationStyleUsername" type="text" placeholder="E-mail"  v-model.trim="form.email" />
    <label for="" class="inf">Password</label>
    <input :style="validationStylePass" type="password" placeholder="Password" v-model.trim="form.password" />
